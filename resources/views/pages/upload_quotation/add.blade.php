...
@endphp
@if( in_array('create_upload_quotation', $user_permisions ) )
<div class="content">
...
@endif        
@if( in_array('list_upload_quotation', $user_permisions ) )
                                    ...
                                    <table id="table" class="table table-striped table-no-bordered table-hover">
                                        <thead class="text-primary">
                                            <tr>
                                                ...
                                                @if( in_array('edit_upload_quotation', $user_permisions ) || in_array('delete_upload_quotation', $user_permisions ) )
                                                    <th>Action</th>
                                                @endif    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @foreach($GenerateQuotation as $GenerateQuotation)
                                                ...
                                                <tr>
                                                    ...
                                                    @if( in_array('edit_upload_quotation', $user_permisions ) )
                                                    ...
                                                    @endif
                                                    @if(in_array('delete_upload_quotation', $user_permisions ) )
