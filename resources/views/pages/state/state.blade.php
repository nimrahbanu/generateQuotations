...
@endphp
@if( in_array('create_state', $user_permisions ) )
<div class="content">
                ...
                @csrf
                    <div class="card">
                        <div class="card-header card-header-primary bg-primary">
                            <h4 class="card-title text-white text-center" >{{ __('STATE FORM') }}</h4>
                        </div>
...
@endif
@if( in_array('list_state', $user_permisions ) )
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="offset-md-1 col-md-10"> 
                                    ...
                                    <table id="table" class="table table-striped table-no-bordered table-hover">
                                        <thead class="text-primary">
                                            <tr>
                                                <th>Id</th>
                                                <th>State</th>
                                                @if( in_array('edit_state', $user_permisions ) ||  in_array('delete_state', $user_permisions ))
                                                    <th>Action</th>
                                                @endif    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @foreach($states as $state)
                                                ...
                                                <tr>
                                                    ...
                                                    @if( in_array('edit_state', $user_permisions ) )
                                                    ...
                                                    @endif
                                                    @if( in_array('delete_state', $user_permisions ) )
