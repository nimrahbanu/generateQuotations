...
@endphp
@if( in_array('create_prospect', $user_permisions ) )
<div class="content">
                        ...
                        <div class="card-body ml-3 mr-3">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-container">
                                        <i class="fa fa-building-o icon" aria-hidden="true"></i>
                                        <select class="form-control" id="package_id" name="package_id" style="height: 39px;">
                                            <option style="height: 39px;"  disabled selected>--Select package Name--</option>
                                            @if($packages) 
                                                @foreach($packages as $package)
                                                <option value="{{$package->id}}" {{old('package_id') == $package->Plannig_package_name ? 'selected': ""}}>{{$package->Plannig_package_name}}</option>
                                                @endforeach 
                                            @else
                                            @php echo('no data'); @endphp
                                            @endif
...
@endif
@if( in_array('list_prospect', $user_permisions ) )
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="offset-md-1 col-md-10"> 
                                    ...
                                    <table id="table" class="table table-striped table-no-bordered table-hover">
                                        <thead  class="text-primary">
                                            <tr>
                                                ...
                                                @if(in_array('edit_prospect', $user_permisions ) || in_array('delete_prospect', $user_permisions ) )
                                                    <th>Action</th>
                                                @endif    
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            @foreach($prospects as $prospect)
                                                ...
                                                <tr>
                                                    ...
                                                    @if( in_array('edit_prospect', $user_permisions ) )
                                                    ...
                                                    @endif  
                                                    @if( in_array('delete_prospect', $user_permisions ) )
